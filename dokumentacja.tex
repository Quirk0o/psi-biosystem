...
\section{Projekt interfejsu użytkownika}
	...
	\begin{landscape}
		\begin{figure}[H]
			\centering
			\centerline{\includegraphics[width=1.8\textwidth]{partials/2-wymagania/dokumenty/dane-klienta.png}}
	...
	\begin{landscape}
		\begin{figure}[H]
			\centering
			\centerline{\includegraphics[width=1.8\textwidth]{partials/2-wymagania/dokumenty/oferta.png}}
